...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        // Base styles
        "flex w-full items-center justify-between gap-2 rounded-lg px-4 py-2 text-sm whitespace-nowrap",
        // Glass background
        "bg-white/[0.06] backdrop-blur-sm",
        // Glass border
        "border border-white/[0.15]",
        // Text colors
        "text-white data-[placeholder]:text-white/40",
        // Icon color
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          // Glass morphism
          "bg-[rgba(26,61,43,0.95)] backdrop-blur-xl",
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        // Hover/focus
        "focus:bg-lime-500/20 focus:text-lime-400",
        // Icon
        "[&_svg:not([class*='text-'])]:text-white/50",
        // Disabled
